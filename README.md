...
여러분의 시스템에 이 과정을 위한 python 요구사항이 설치되어 있어 합니다. 저장소의 최상위 디렉토리에서 다음을 실행하십시요. 
데이터 변환과 학습에 사용되는 Tensorflow는 tf1 api를 사용합니다. 
Backend.AI 사용자는 미리 생성된 Tensorflow:1.15-py36-cuda10 커널을 사용하면 본 과정은 생략할 수 있습니다. 
